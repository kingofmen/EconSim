...
NDiplomacy = {
	...
	REALM_DIPLOMACY_OPINION_MUL_FACTOR = 0.5,					-- Realm diplomacy factor affecting opinion value
...
NCharacter = {
	...
	ADULT_DIPLOMACY_OPINION_MUL_FACTOR = 3,			-- Adult diplomacy factor affecting opinion value
	CHILD_DIPLOMACY_OPINION_SUB_FACTOR = 4,			-- Adult diplomacy factor affecting opinion value
	CHILD_DIPLOMACY_OPINION_MUL_FACTOR = 3,			-- Adult diplomacy factor affecting opinion value
...
NEconomy = {
	...
	TRADE_ZONE_BONUS_MULT_CITY = 0.002,				-- Cities gain similar bonus for a tradepost being in the province
	...
	OVERSIZED_COURT_UPKEEP_COST = 0,			-- Amount of ducats paid per month for the upkeep of each courtier above the court limit.
	OVERSIZED_COURT_PRESTIGE_GAIN = 0,			-- Amount of prestige gained per month for each courtier above the court limit.
},
...
NMilitary = {
	...
	LOOTED_MODIFIER_MONTHS = 120,					-- How long pagan looting lasts
	...
	CAPITAL_KINGDOM_LIEGE_LEVY_MULT = 0.7,
	CAPITAL_EMPIRE_LIEGE_LEVY_MULT = 0.6,
